...
function StoryCard(t0) {
    ...
    if ($[0] !== "0acba51a6d395e82fb9045763d70ca72834d472df1fdb34d699619ae8e9a7d26") {
        for(let $i = 0; $i < 49; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0acba51a6d395e82fb9045763d70ca72834d472df1fdb34d699619ae8e9a7d26";
    }
    const { story } = t0;
    const formatDate = _StoryCardFormatDate;
    const formatNumber = _StoryCardFormatNumber;
    const t1 = `/story/${story.id}`;
    let t2;
    if ($[1] !== story.category) {
    ...
    let t3;
    if ($[3] !== story.createdAt) {
        t3 = formatDate(story.createdAt);
        $[3] = story.createdAt;
        $[4] = t3;
    } else {
        t3 = $[4];
    ...
    if ($[14] !== story.author.avatar) {
        ...
        $[14] = story.author.avatar;
        $[15] = t8;
    } else {
        t8 = $[15];
    }
    let t9;
    if ($[16] !== story.author.name) {
    ...
    let t12;
    if ($[22] !== story.stats.views) {
        t12 = formatNumber(story.stats.views);
        $[22] = story.stats.views;
        $[23] = t12;
    } else {
        t12 = $[23];
    }
    ...
    let t15;
    if ($[27] !== story.stats.comments) {
        t15 = formatNumber(story.stats.comments);
        $[27] = story.stats.comments;
        $[28] = t15;
    } else {
        t15 = $[28];
    }
    ...
    let t18;
    if ($[32] !== story.stats.likes) {
        t18 = formatNumber(story.stats.likes);
        $[32] = story.stats.likes;
        $[33] = t18;
    } else {
        t18 = $[33];
    }
    ...
    let t22;
    if ($[43] !== t1 || $[44] !== t21 || $[45] !== t5 || $[46] !== t6 || $[47] !== t7) {
                ...
                children: [
                    ...
                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                children: "Henüz hikaye yok. İlk hikayeyi siz ekleyin!"
                            }, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 46,
                                columnNumber: 13
...
_s(Home, "zCjlpGcoUr1rea4W35sCCv7lOUw=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_260181a8._.js.map