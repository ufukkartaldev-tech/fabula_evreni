...
"[project]/src/app/components/LevelUpToast.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LevelUpToast() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(13);
    if ($[0] !== "94308ccc0e232649e23c798d18cf19367bbb76a776d522d80519c3812fdbf52d") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "94308ccc0e232649e23c798d18cf19367bbb76a776d522d80519c3812fdbf52d";
    }
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    if ($[1] !== user) {
        t0 = ({
            "LevelUpToast[useEffect()]": ()=>{
                if (!user) {
                    return;
                }
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notificationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToNotifications"])(user.uid, {
                    "LevelUpToast[useEffect() > subscribeToNotifications()]": (notifications)=>{
                        ...
                        if (latest && latest.type === "badge_earned" && !latest.read) {
                            ...
                            if (diff < 10000) {
                                ...
                                setTimeout({
                                    "LevelUpToast[useEffect() > subscribeToNotifications() > setTimeout()]": ()=>{
                                        setToast(null);
                                    }
                                }["LevelUpToast[useEffect() > subscribeToNotifications() > setTimeout()]"], 5000);
                            }
                        }
                    }
                }["LevelUpToast[useEffect() > subscribeToNotifications()]"]);
                return ()=>unsubscribe();
            }
        })["LevelUpToast[useEffect()]"];
        t1 = [
...
_s(LevelUpToast, "hPVIitRIqwArsPdfguHuiU1bjoI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
_c = LevelUpToast;
var _c;
__turbopack_context__.k.register(_c, "LevelUpToast");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f9b80b7d._.js.map